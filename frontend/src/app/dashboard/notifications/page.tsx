    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          ...
          <p className="text-on-surface-variant">You're all caught up! We'll notify you of important updates here.</p>
        </div>
      ) : (
          ...
          {notifications.map((notification: any, i: number) => {
            ...
            return (
              ...
              >
                <Card
                  hover
                  className={`${!notification.is_read ? "border-l-4 border-l-primary-400" : ""}`}
                  padding="sm"
                >
                  <div className="flex items-start gap-3">
                    ...
                    {!notification.is_read && (
                      <button
                        ...
                        className="shrink-0 text-xs text-on-surface-variant hover:text-primary-500 transition-colors"
                      >
                        Mark read
                      </button>
                    )}
